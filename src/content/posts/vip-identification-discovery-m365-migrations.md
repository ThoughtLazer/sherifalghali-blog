...
## The Problem Wasn't Just Triage
...
The policies weren't wrong. It was a good security posture. The gap was in our discovery, not their configuration. If we had caught this during planning, we would have had options: work with the VIP to modify his workflow to better match the acquiring company's environment, request a targeted policy exception for the sales team, or find a middle ground like enabling contact sync with restricted fields. Those are conversations that have to happen during the planning phase with the client. They're not available to you during post-migration support when the user is already frustrated and escalating.
...
## Conclusion: Catch It Early, and You Have Options
